...
public class Images extends TableImpl<ImagesRecord> {
	...
	private static final long serialVersionUID = -1894934319;
	...
	/**
	 * The column <code>public.images.img</code>.
	 */
	public final TableField<ImagesRecord, String> IMG = createField("img", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), this, "");
